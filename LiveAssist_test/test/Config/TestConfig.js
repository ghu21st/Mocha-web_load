//Global QA Mocha test parameters/variables settings
exports.options = {
  server          : "10.3.41.54",                     //mt-ray-vm01, Live Assist server for load test
//  server          : "10.3.41.56",                     //AHP: mt-ray-vm03, AHP test
//  server            : "10.3.41.59",                   //mt-ray-vm06, regression - QA1
//  server            : "10.3.41.60",                     //mt-ray-vm07, Live Assist server for JMeter test or api+gui load test
//  server          : "10.3.41.61",                     //mt-ray-vm08, regression - QA2

//  port              : 8080,                             //default Live Assist server port
  port              : 8083,                             //default Live Assist server port
  test_location     : "c:\\LiveAssist_test\\test",      //test base folder

//  test_Url          : "https://10.3.41.54:8443/liveassist/app/", //for Live Assist AngularJS GUI test 
  test_Url          : "https://10.3.41.54:8446/liveassist/app/", //for Live Assist AngularJS GUI test 
//  test_Url          : "https://10.3.41.60:8443/liveassist/app/", //for Live Assist AngularJS GUI test 
...
//  browser_driver    : "firefox",            //config browser driver to "firefox". NOTE: need to start selenium standalone server + Firefox driver first (or batch file)
  ...
  ptor_timeout_regression : 40000,                     // protractor driver & script time out
...
//MySQL
  ...
  LA_mysql_database     : "liveassist",
	...
	//ivr/web api - multi-channel concurrent smoke test
//	api_call_number	 : 3,				   	//for api each 1400 calls x 8 agents = total 11200 iter (note: api_call_number = expected call iter number + 100, to make sure all the api test iteration can be completed)
//	gui_run_number   : 3                      //for gui response, each 1400 x 8 agents = total 11200 call iterations (note: gui_run_number = api_call_number + 200, to make sure all the GUI test iteration can be completed)

	//ivr/web api - 9chl, target each chl 1850 calls, total 16650
//	api_call_number	 : 2500,				   	//actual  calls for each cbannel x 9 agents = total 18000 call iter (note: api_call_number = expected call iter number + 100, to make sure all the api test iteration can be completed)
//	gui_run_number   : 3000                     //for gui response, each 2000 x 9 agents = total 18000 call iterations (note: gui_run_number = api_call_number + 100, to make sure all the GUI test iteration can be completed)

	api_call_number	 : 1200,				   	//actual  calls for each cbannel x 9 agents = total 18000 call iter (note: api_call_number = expected call iter number + 100, to make sure all the api test iteration can be completed)
	gui_run_number   : 1500                     //for gui response, each 2000 x 9 agents = total 18000 call iterations (note: gui_run_number = api_call_number + 100, to make sure all the GUI test iteration can be completed)
