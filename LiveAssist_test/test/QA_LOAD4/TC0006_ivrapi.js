//TC0006-ivrapi: Live Assist load test ivr api call script
//-------------------------------------------------------
var case_ID = '0006-ivrapi';
var channel_id = '0006'; // note: the # can be the same like agent id without 'TA' prefix
