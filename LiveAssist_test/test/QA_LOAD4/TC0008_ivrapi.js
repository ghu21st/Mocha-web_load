//TC0008-ivrapi: Live Assist load test ivr api call script
//-------------------------------------------------------
var case_ID = '0008-ivrapi';
var channel_id = '0008'; // note: the # can be the same like agent id without 'TA' prefix
