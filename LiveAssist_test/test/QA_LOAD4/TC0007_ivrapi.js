//TC0007-ivrapi: Live Assist load test ivr api call script
//-------------------------------------------------------
var case_ID = '0007-ivrapi';
var channel_id = '0007'; // note: the # can be the same like agent id without 'TA' prefix
