//TC0004: Live Assist load test script with simple app IVR api + Agent GUI
//Note: GUI with agent EXPLAIN_FEE_REQUEST intent selection!
//-------------------------------------------------------
var case_ID = '0004-gui';
var agent_id = 'TA0004';
...
var selenium_server = 'http://' + TestConfig.options.second_selenium_host + ':4444/wd/hub';
...
async.whilst(
    ...
    function(callback0){
        ...
        async.series([
           ...
           function(callback){
                    //GUI with agent EXPLAIN_FEE_REQUEST intent selection!  ##############
