//TC0000-ivrapi: Live Assist load test ivr api call script
//TA0000 - note: confidence = 0.9 > default 0.5! with ASR 'operator', no agent logged in needed!
//-------------------------------------------------------
var case_ID = '0000-ivrapi';
var channel_id = '0000'; // note: the # can be the same like agent id without 'TA' prefix
    ...
    function(callback0){
        ...
        async.series([
            ...
            function(callback){
				...
				//set the paramer to be posted to triggered api call ******* TA0000 - note: confidence = 0.9 > default 0.5 or QA customized 0.8 (optional) for testing! with ASR 'operator' *************
                var testBodyParam = "ani=sip%3A5145551234%4010.3.53.192%3A5064&dnis=sip%3A4627%40mtl-da53&externalSessionID=" + call_externalSessionID + "&sessionID=&configurationName=othermenu&completionCause=success&recognitionResult=%3C%3Fxml%20version%3D%271.0%27%3F%3E%3Cemma%3Aemma%20version%3D%221.0%22%20xmlns%3Aemma%3D%22http%3A%2F%2Fwww.w3.org%2FTR%2F2007%2FCR-emma-20071211%22%20xmlns%3Anuance%3D%22http%3A%2F%2Fnr10.nuance.com%2Femma%22%3E%3Cemma%3Agrammar%20id%3D%22grammar_1%22%20ref%3D%22session%3Ahttp%3A%2F%2F10.3.41.59%3A8080%2Fliveassist%2Fdata%2Fvxmldemo%2Fivrapi%2Fcallsteering%2Fmainmenu.grxml%20-1%20-1%2010000%22%2F%3E%3Cemma%3Ainterpretation%20id%3D%22interp_1%22%20emma%3Aconfidence%3D%220.9%22%20emma%3Agrammar-ref%3D%22grammar_1%22%20emma%3Atokens%3D%22OPERATOR%22%20emma%3Aduration%3D%221220%22%20emma%3Amode%3D%22voice%22%20nuance%3Aeos-silence%3D%221340%22%3E%3CINTENT%20%0Aconf%3D%220.9%22%3EOPERATOR%3C%2FINTENT%3E%3CSWI_literal%3EOPERATOR%3C%2FSWI_literal%3E%3CSWI_meaning%3E%7BINTENT%3AOPERATOR%7D%3C%2FSWI_meaning%3E%3C%2Femma%3Ainterpretation%3E%3C%2Femma%3Aemma%3E%0A%0A%0A&utterance=http%3A%2F%2Fmtl-bl1-12-vm02%3A90%2FNuance%2FcallLogs%2FIvrApiCallSteering%2F2014%2F06June%2F18%2F15%2FNUAN-09-13-mtl-bl1-12-vm02-0a032969_00002680_53a1e3d9_0007_0001-utt001-SAVEWAVEFORM.wav";
            ...
            function(callback){
                ...
                setTimeout(function(){
                    ...
                    callback(null, 2);
                }, 3000); //old: 1000, special for channel 0
            },
            ...
            function(callback){
                ...
                var chk_str = '>useASRResult<'; // ********** TA0000 - Note: changed for using ASR result when confidence > 0.5 default ************************
                //
                async.whilst(
                    ...
                    function(cb){
                        ...
                        test_client.post(testAPIURL + '/inputInteractionStep', testBodyParam, function(err, res, body){
                            if(err){
								...
								//for debug
								logger.info('\n for debug - body_ret return: ' + body_ret + '\n');
            ...
            function(err, result){
                ...
                if(err){
                    ...
                    var chk2_str = '<state>useASRResult</state>';
                    var chk3_str = '<state>useASRResult</state>';
