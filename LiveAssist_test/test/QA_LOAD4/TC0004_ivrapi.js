//TC0004-ivrapi: Live Assist load test ivr api call script
//-------------------------------------------------------
var case_ID = '0004-ivrapi';
var channel_id = '0004'; // note: the # can be the same like agent id without 'TA' prefix
