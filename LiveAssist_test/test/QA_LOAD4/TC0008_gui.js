//TC0008: Live Assist load test script with simple app IVR api + Agent GUI
//Note: GUI with agent WAIVE_FEE_REQUEST intent selection!
//-------------------------------------------------------
var case_ID = '0008-gui';
var agent_id = 'TA0008';
...
var selenium_server = 'http://' + TestConfig.options.third_selenium_host + ':4448/wd/hub';
...
async.whilst(
    ...
    function(callback0){
        ...
        async.series([
           ...
           function(callback){
                    //// GUI with agent WAIVE_FEE intent selection!  ##############
