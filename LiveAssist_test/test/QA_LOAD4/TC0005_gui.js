//TC0005: Live Assist load test script with simple app IVR api + Agent GUI
//Note: GUI with agent OPERATOR intent selection!
//-------------------------------------------------------
var case_ID = '0005-gui';
var agent_id = 'TA0005';
...
var selenium_server = 'http://' + TestConfig.options.second_selenium_host + ':4445/wd/hub';
...
/*            function(callback){
				...
				element1 = ptor.element.all(protractor.By.repeater('intent in intents')).then(function(arr){
					arr[3].evaluate('intent.name').then(function(intent_name){
