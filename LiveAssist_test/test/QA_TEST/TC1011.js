/**
 TC1011: Verify that Live Assist MRCP driven API method /endSession
 **/
//QA test case description, verification & assertion check
describe("TC1011: Verify that Live Assist MRCP driven API method /endSession", function () {
    //QA test setup ----------------------------------------------
...
//                            console.log('\ndeleted module:' + key);
    ...
    it("TC1011: Verify that Live Assist MRCP driven API method /endSession", function (done) {
