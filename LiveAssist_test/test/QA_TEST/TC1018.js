/**
 TC1018: Verify that Live Assist load correct application context configuration for valid applicationID and grammars URI that exist in the configuration
 **/
//QA test case description, verification & assertion check
describe("TC1018: Verify that Live Assist load correct application context configuration for valid applicationID and grammars URI that exist in the configuration", function () {
    //QA test setup ----------------------------------------------
...
//                            console.log('\ndeleted module:' + key);
    ...
    it("TC1018: Verify that Live Assist load correct application context configuration for valid applicationID and grammars URI that exist in the configuration", function (done) {
