/**
 TC1004: Verify that session storage debug API delete sessions
 **/
//QA test case description, verification & assertion check
describe("TC1004: Verify that session storage debug API delete sessions", function () {
    //QA test setup ----------------------------------------------
...
//                            console.log('\ndeleted module:' + key);
            ...
            if(err){
                console.log('\nWarning happened from the case -after- block!\n');
            }
            //calculate test elapse
            test_endTime = new Date();
            test_elapse = test_endTime - test_startTime;
    ...
    it("TC1004: Verify that session storage debug API delete sessions", function (done) {
