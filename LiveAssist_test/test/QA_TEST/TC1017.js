/**
 TC1017: Verify that Live Assist load application context configuration load default value when configurationName and grammars fields do not exist
 **/
//QA test case description, verification & assertion check
describe("TC1017: Verify that Live Assist load application context configuration load default value when configurationName and grammars fields do not exist", function () {
    //QA test setup ----------------------------------------------
...
//                            console.log('\ndeleted module:' + key);
    ...
    it("TC1017: Verify that Live Assist load application context configuration load default value when configurationName and grammars fields do not exist", function (done) {
        ...
        async.series([
            ...
            function(callback){
                ...
                var testBodyParam = JSON.stringify({
                    "sessionID": sessionID
                    //"configurationName":"mainmenu",                                                          //####### Set none for this case testing ##################
                    //"grammars":["http://mt-ray-vm06:8080/liveassist/data/vxmldemo/travel/mainmenu.grxml"]    //####### Set none for this case testing ##################
                });
