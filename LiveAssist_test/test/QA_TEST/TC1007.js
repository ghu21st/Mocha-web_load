/**
TC1007: Verify that session storage debug API get session {id} and basic session storage info
 **/
//QA test case description, verification & assertion check
describe("TC1007: Verify that session storage debug API get session {id} and basic session storage info", function () {
    //QA test setup ----------------------------------------------
...
//                            console.log('\ndeleted module:' + key);
    ...
    it("TC1007: Verify that session storage debug API get session {id} and basic session storage info", function (done) {
        ...
        async.series([
            ...
            function(callback){
                ...
                test_client.get(testBaseURL + '/session/' + sessions[1], function(err, res, body){
                    if(err){
