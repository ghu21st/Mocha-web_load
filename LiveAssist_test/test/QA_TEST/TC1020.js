/**
 TC1020: Verify that updated Live Assist MRCP driven API method /sendRecognitionResult with state and completionCause check
 **/
//QA test case description, verification & assertion check
describe("TC1020: Verify that updated Live Assist MRCP driven API method /sendRecognitionResult with state and completionCause check", function () {
    //QA test setup ----------------------------------------------
...
//                            console.log('\ndeleted module:' + key);
    ...
    it("TC1020: Verify that updated Live Assist MRCP driven API method /sendRecognitionResult with state and completionCause check", function (done) {
        ...
        async.series([
            ...
            function(err, result){
                ...
                try{
                    ...
                    expect(result[5][1].completionCause).to.match(/no-input-timeout/);
                    expect(result[5][1].state).to.match(/useLiveAssistResult/);

                    expect(result[7][0].statusCode).to.eql(200);  //note: /endSession API call return '204 Not Content'
