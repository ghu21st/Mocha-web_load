/**
 TC1012: Verify that Live Assist MRCP driven API method /startRecognition
 **/
//QA test case description, verification & assertion check
describe("TC1012: Verify that Live Assist MRCP driven API method /startRecognition", function () {
    //QA test setup ----------------------------------------------
...
//                            console.log('\ndeleted module:' + key);
    ...
    it("TC1012: Verify that Live Assist MRCP driven API method /startRecognition", function (done) {
        ...
        async.series([
            ...
            function(err, result){
                ...
                try{
                    ...
                    expect(result[3][0].statusCode).to.eql(200);  //note: /endSession API call return '200' but no return value
                    //expect(result[3][1]).to.match(//); //note: no response from /endSession API call
