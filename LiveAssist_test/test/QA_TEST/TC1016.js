/**
 TC1016: Verify that Live Assist load correct application context configuration based on orgnizationID applicationID configurationName and no grammars
 **/
//QA test case description, verification & assertion check
describe("TC1016: Verify that Live Assist load correct application context configuration based on orgnizationID applicationID configurationName and no grammars", function () {
    //QA test setup ----------------------------------------------
...
//                            console.log('\ndeleted module:' + key);
    ...
    it("TC1016: Verify that Live Assist load correct application context configuration based on orgnizationID applicationID configurationName and no grammars", function (done) {
        ...
        async.series([
            ...
            function(callback){
                ...
                var testBodyParam = JSON.stringify({
                    ...
                    //"grammars":["http://mt-ray-vm06:8080/liveassist/data/vxmldemo/travel/mainmenu.grxml"]         //########## No grammars assigned for this case #############
                });
